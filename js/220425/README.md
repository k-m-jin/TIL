...
## string method
```js
console.log(str.includes('slkfjl')) //Boolean 으로 반환
console.log(str.indexOf('slkfjl')) // 없다면 -1 반환
console.log(str.match(/regexp/)) 
console.log(str.replace('찾을문자', '넣을문자')) // 지울때도 사용,정규식가능 
console.log(str.slice('시작인덱스', '종료인덱스의직전'))  //-1 은 마지막 문자
console.log(str.split('기준문자', '')) // 기준문자로 나누어 배열로 반환
console.log(str.toUpperCase()) // 대문자로
console.log(str.toUpperCase()) // 대문자로
console.log(str.trim()) // 앞뒤 공백 문자제거
```
